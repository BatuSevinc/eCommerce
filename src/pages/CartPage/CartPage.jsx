    ...
    return(
      <div className="container my-5">
        <div className="empty-cart flex justify-center align-center flex-column font-manrope">
          ...
          <span className="fw-6 fs-15 text-gray">Yours shopping cart is empty.</span>
          <Link className="shopping-btn bg-orange">Go Shopping Now</Link>
          </div>
      </div>
    )
  }
              ...
              carts.map((cart,index)=>(
                <div className="cart-ctr py-4" key={cart?.id}>
                  <div className="cart-ctd">
                    ...
                    <div className="cart-ctd">
                      <div className="qty-change flex align-center"><button type="button" className="qty-decrease flex align-center justify-center" onClick={() => dispatch(toggleCartQty({id: cart?.id,type:"DEC"}))}>
