          ...
          <div className="header-cnt-top fs-13 py-2 flex align-center justify-between">
              ...
              <ul className="flex top-links align-center">
                ...
                <li className='flex align-center'>
                  ...
                  <ul className='social-links flex align-center'>
                    <li className="mx-2">
                      <Link to="https://www.facebook.com" className='fs-15'>
                        <i className='fab fa-facebook'></i>
                      </Link>
                    </li>
                    <li className="mx-2">
                      <Link to="https://www.instagram.com" className='fs-15'>
            ...
            <div className="header-cnt-top-r">
              <ul className="top-links flex align center">
                ...
                <li className="vert-line"></li>
                <li>
                  <Link to="/"><span className="top-link-itm-txt">Register</span></Link>
                </li>
                <li className="vert-line"></li>
                <li>
                  <Link><span className="top-link-itm-txt">Login</span></Link>
                </li>
              </ul>
            </div>
          </div>
